...
df_filter = df[df['question'].str.startswith(('Why'), na=False)].copy()
df_filter = df_filter.drop_duplicates(subset=['question'])
df_filter['label'] = 4
df_filter.to_json('/home/jyli/characteristic_identify/data/our_data/question_type/train/squad_why_train.json',orient='records',lines=True)
...
df_filter = df_filter.drop_duplicates(subset=['question'])
df_filter['label'] = 4
df_filter.to_json('/home/jyli/characteristic_identify/data/our_data/question_type/validate/squad_why_validate.json',orient='records',lines=True)
print(df_filter.head(5))
print(df_filter.columns.tolist())